...
- All Plugins Listed below are GPL.
- Plugins might have Lite & Pro versions.
...
- [GADWP by ExactMetrics](https://wordpress.org/plugins/google-analytics-dashboard-for-wp/)
...
- [BlogVault Backups](https://wordpress.org/plugins/blogvault-real-time-backup/)
...
- [PowerPack for Beaver](https://wordpress.org/plugins/powerpack-addon-for-beaver-builder/)
...
- [Registration Options](https://wordpress.org/plugins/bp-registration-options/)
- [Buddyforms](https://wordpress.org/plugins/buddyforms/)

### Booking Plugins
- [Easy Appointments](https://wordpress.org/plugins/easy-appointments/)
- [Appointments By WPMU Dev](https://wordpress.org/plugins/appointments/)
- [Booking & Appointment for WooCommerce](https://www.tychesoftwares.com/store/premium-plugins/woocommerce-booking-plugin/)
...
- [Hummingbird Cache](https://wordpress.org/plugins/hummingbird-performance/)
...
- [Disqus Comments System](https://wordpress.org/plugins/disqus-comment-system/)
...
- [Comment Redirect](https://wordpress.org/plugins/comment-redirect/)
...
- [Astra Security - Web Application Firewall & Malware Scanner ](https://wordpress.org/plugins/getastra/)
